...
placés dans awawa-project-methodology. ~~Ne lit aucun autre fichier, à part celui-ci et findings.md.~~ (amendement
2026-09-16: limite révoquée car le fichier est maintenant prêt à servir de base pour la migration).
...
`implemented` with anchors (`../../AGENTS.md` ×3, `docs/_schema.awawa` ×5, corpus files ×5, code/scripts/`.github`
×4), 20
...
to `../game-rules.md`; findings §3's « six entities pay a fictional `REJECTED` » is not what the tool shows. They
stay
...
the wrong field), 1 anchors `src/application/responses` (core_mapping, one Response per file), 1 anchors
`../../fallow.toml`
...
Membership: a dated usage report under `../awawa-usage-reports`, cited as the origin of an entity. Written only
...
| Field name | Role                                                                                                                                                                                                                                                                 | Accepted values                | Is repeatable | Is required |
|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|---------------|-------------|
| FILE       | the report file, `path::tag` — the literal is a raw text search in the file; the tag is a line placed **at the top of the report template** (`../awawa-usage-reports/_template.md`), not a heading (ruled 2026-09-16); L016 reports a moved report and a missing tag | anchor                         | no            | yes         |
...
aggregates without a pull request), 5 exports under `artifact-assets`, 1 under `intellij-plugins`, `_template.md`.
...
the same day. Next: the user's manual clean of `..` (step 0b), before any migration.
...
|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| 0    | **retrospective — done 2026-09-16** (point 21): session scan (section « Scan des sessions (rétrospective) ») and the proposal to the awawa team, written directly as `../awawa-usage-reports/migration/2026_09_16-second-project-methodology-migration/2026-09-16-corpus-bootstrap-method.md` (the user chose the folder over a section of this file; untracked, to commit with the migration's first pull request or before): ten bootstrap steps with their measures, what it refuses, the 23 defects and 25 strengths annexed integrally, ten proposals to the tool's authors, the four out-of-corpus levers named and left to the project                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | the sessions, this file, `findings.md`                                 | session scan, one usage report                                                |
| 0b   | **the user cleans `..` by hand, before step 1** (asked 2026-09-16): a reminder only, what the clean covers is theirs to decide                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `..`                                                                   | —                                                                             |
...
Livrable écrit directement dans
