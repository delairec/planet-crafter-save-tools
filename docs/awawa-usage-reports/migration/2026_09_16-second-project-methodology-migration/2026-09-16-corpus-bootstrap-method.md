...
| **Sessions measured**                           | period A: 56 sessions from tag `before-awawa` (2026-09-11 17:23:31+02:00) to the first write in `../../../awawa-project-methodology/work_in_progress.md` (2026-09-16 10:19:40 UTC); period B: the 3 sessions of the refinement work; scripts `scan.py`, `metrics.py` |
...
| 7  | Entities whose subject is the tool, not the project                       | 3 limitations of awawa, 4 rules that had left for the general instructions                                                                                      | `../../../awawa-project-methodology/findings.md` §5; removed on request three times (14–15 Sept.) |
...
| 11 | Fields hiding in `DESC`/`RATIONALE` prose                                 | 21 occurrences of 5 recurring openings                                                                                                                          | `../../../awawa-project-methodology/findings.md` §4                                               |
| 12 | Cost of settling the target structure                                     | 32 rulings, 14 review steps, 45 named throwaway corpora + 17 lettered variants, 141 probe rows, 9 refused forms, 23 defects, 25 strengths, one day (2026-09-16) | `../../../awawa-project-methodology/work_in_progress.md`, counted by `grep`/`awk`                 |
...
| 3 | A family read from prose and refuted by the tool    | `../../../awawa-project-methodology/findings.md` §3 counted 6 facts paying a fictional `REJECTED`; `show` on the six: each has 2–3 substantive `REJECTED` and `SPEC › IMPL` to code — 0 to retype |
...
Previous reports of this folder were not read for this synthesis (the retrospective read
`../../../awawa-project-methodology/work_in_progress.md` and
`../../../awawa-project-methodology/findings.md` only, by instruction); « times seen » is therefore unchecked except
...
| # | Claim                                                                                                                      | Check                                                                                                 | Verdict                                                                                                                                                                                |
|---|----------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1 | `../../../awawa-project-methodology/findings.md` §3: six `format-save` decisions are facts paying a fictional `REJECTED`   | `show` on the six on 2026-09-16: each carries 2–3 substantive `REJECTED` and `SPEC › IMPL` to code    | wrong                                                                                                                                                                                  |
| 2 | `../../../awawa-project-methodology/findings.md` §1: 137 `DECISION`, 6 superseded; 61 `OPEN_QUESTION`, 21 open / 40 closed | `status DECISION docs` on 2026-09-16: 145 / 12 superseded; `status OPEN_QUESTION docs`: 20 / 41       | overstated by date: the corpus moved between the two readings; the outline recounts at migration                                                                                       |
