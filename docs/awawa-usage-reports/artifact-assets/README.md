...
| `2026-09-16-corpus-bootstrap-method.md` | The bootstrap method report behind the Migration 2 report and the starter, cleared of every reference to the project's files. The page embeds it for its download button.                                   |
