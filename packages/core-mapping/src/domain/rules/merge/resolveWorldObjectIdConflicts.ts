 ...
 */
export function resolveWorldObjectIdConflicts(worldObjects: EntriesByOrigin<DecodedWorldObject>, idSequence: IdSequence): ResolvedEntries<DecodedWorldObject> {
