...
- fix: remove type errors introduced by rebase conflicts
...
- refactor(mergeInventories): improve spec and move global object test to where it belongs
- refactor: clean up typings to have one source of truth
- refactor: update save file schema to remove Terrain Layers section and adjust indices
- feat: handle save files backward compatibility
- refactor: improve specs and refactor tests
- refactor(mergeMailboxes): improve spec
- refactor(mergeInventories): improve spec and move global object test to where it belongs
- refactor(mergeGlobalMetadata): fix GR-META-3 inconsistency and improve spec
